...
public class BookFlight extends JFrame implements ActionListener {
    ...
    public BookFlight() {
        ...
        heading.setBounds(420, 20, 800, 35);
        ...
        fetchButton.setForeground(Color.pink);
        ...
        flight.setForeground(Color.pink);
        ...
        labelfname = new JLabel("Flight Name");
        ...
        labelfcode.setBounds(620, 480, 150, 25);
        add(labelfcode);
        ...
        bookflight.setForeground(Color.pink);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == fetchButton) {
            ...
            if(ae.getSource()== bookflight && tfaadhar == null) {
            	JOptionPane.showMessageDialog(null, "Fill Aadhar Card");
            }
